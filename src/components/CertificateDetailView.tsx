    ...
    if (selectedCertificate) {
      ...
      data = [
        [
          ...
          /* {
             label: 'Claimed',
             data: selectedCertificate. ? 'yes' : 'no'
           },*/
          {
          ...
          {
            label: 'Creation Date',
            data: moment(selectedCertificate.dateTimeFrom * 1000).format('DD MMM YY')
          },
          {
            label: 'dateTimeFrom',
            data: moment(selectedCertificate.dateTimeFrom * 1000).format('DD MMM YY')
          ...
          {
            label: 'dateTimeTo',
            data: moment(selectedCertificate.dateTimeTo * 1000).format('DD MMM YY')
          }/*,
          {
            label: 'fileHash',
            data: selectedCertificate.powerProfileHash
          },
          {
            label: 'URL',
            data: selectedCertificate.powerProfileURL
          }*/,
          {
            label: 'confirmed',
            data: '' + selectedCertificate.reportConfirmed
          },
          {
            label: 'activationID',
            data: selectedCertificate.activationId
          }

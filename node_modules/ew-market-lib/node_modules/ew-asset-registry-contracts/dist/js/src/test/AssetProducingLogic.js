...
describe('AssetProducingLogic', () => {
    ...
    it('should not deploy an asset when the user does not have the assetManager rights as assetManager', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.createAsset(assetSmartmeter, assetOwnerAddress, true, [matcher], 'propertiesDocumentHash', 'url', 2, {
    ...
    it('should not deploy an asset when the user does not have the assetManager rights as user', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.createAsset(assetSmartmeter, assetOwnerAddress, true, [matcher], 'propertiesDocumentHash', 'url', 2, { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'user does not have the required role');
    ...
    it('should return empty asset when smart meter is not onboarded yet', () => __awaiter(this, void 0, void 0, function* () {
        const deployedAsset = yield assetProducingLogic.getAssetBySmartMeter(assetSmartmeter);
        // all the properties are in 1 struct
        chai_1.assert.equal(deployedAsset.length, 2);
    ...
    it('should throw when trying to access a non exsting AssetGeneral-Struct', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.getAssetGeneral(0);
        }
        catch (ex) {
            failed = true;
        }
    ...
    it('should onboard a new asset', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.createAsset(assetSmartmeter, assetOwnerAddress, true, [matcher], 'propertiesDocumentHash', 'url', 2, { privateKey: privateKeyDeployment });
    ...
    it('should have 1 asset in the list', () => __awaiter(this, void 0, void 0, function* () {
        chai_1.assert.equal(yield assetProducingLogic.getAssetListLength(), 1);
    }));
    it('should return the deployed asset correctly', () => __awaiter(this, void 0, void 0, function* () {
        const deployedAsset = yield assetProducingLogic.getAssetById(0);
        // producing has 2 properties: maxOwnerChanges + assetGeneralStruct
        chai_1.assert.equal(deployedAsset.length, 2);
        chai_1.assert.equal(deployedAsset.maxOwnerChanges, 2);
        // checking the number of properties in assetGeneral
        chai_1.assert.equal(deployedAsset.assetGeneral.length, 10);
        const ag = deployedAsset.assetGeneral;
        ...
        chai_1.assert.equal(ag.url, 'url');
        chai_1.assert.equal(ag.marketLookupContract, '0x0000000000000000000000000000000000000000');
        chai_1.assert.isFalse(ag.bundled);
    }));
    it('should return asset by smartmeter correctly', () => __awaiter(this, void 0, void 0, function* () {
        const deployedAsset = yield assetProducingLogic.getAssetBySmartMeter(assetSmartmeter);
        chai_1.assert.equal(deployedAsset.length, 2);
        chai_1.assert.equal(deployedAsset.maxOwnerChanges, 2);
        // checking the number of properties in assetGeneral
    ...
    it('should return assetGeneral correctly', () => __awaiter(this, void 0, void 0, function* () {
        const ag = yield assetProducingLogic.getAssetGeneral(0);
        chai_1.assert.equal(ag.smartMeter, assetSmartmeter);
        chai_1.assert.equal(ag.owner, assetOwnerAddress);
        chai_1.assert.equal(ag.lastSmartMeterReadWh, 0);
        chai_1.assert.isTrue(ag.active);
    ...
    it('should fail when trying to log with saveSmartMeterRead using the wrong smartmeter', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.saveSmartMeterRead(0, 100, 'lastSmartMeterReadFileHash', { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
    ...
    it('should be able log to with saveSmartMeterRead with the right account', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.saveSmartMeterRead(0, 100, 'lastSmartMeterReadFileHash', { privateKey: assetSmartmeterPK });
        const event = (yield assetProducingLogic.getAllLogNewMeterReadEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }))[0];
    ...
    it('should fail when trying to log with saveSmartMeterRead and a too low meterreading', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.saveSmartMeterRead(0, 50, 'lastSmartMeterReadFileHash', { privateKey: assetSmartmeterPK });
        }
        catch (ex) {
            failed = true;
    ...
    it('should be able to log with saveSmartMeterRead again using the right values', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.saveSmartMeterRead(0, 200, 'lastSmartMeterReadFileHash#2', { privateKey: assetSmartmeterPK });
        const event = (yield assetProducingLogic.getAllLogNewMeterReadEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }))[0];
        chai_1.assert.equal(event.event, 'LogNewMeterRead');
        chai_1.assert.deepEqual(event.returnValues, {
            0: '0',
    ...
    it('should fail when trying to deactive an asset as non-manager', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setActive(0, false, { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'user does not have the required role');
    ...
    it('should be able to deactive an asset', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.setActive(0, false, { privateKey: privateKeyDeployment });
        const eventActive = (yield assetProducingLogic.getAllLogAssetSetActiveEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }));
        chai_1.assert.equal(eventActive.length, 0);
        const eventInactive = (yield assetProducingLogic.getAllLogAssetSetInactiveEvents({ fromBlock: tx.blockNumber - 1, toBlock: tx.blockNumber + 1 }))[0];
        chai_1.assert.equal(eventInactive.event, 'LogAssetSetInactive');
        chai_1.assert.deepEqual(eventInactive.returnValues, {
            0: '0', _assetId: '0',
        });
    }));
    it('should fail when trying to log with saveSmartMeterRead with a deactivated asset', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.saveSmartMeterRead(0, 300, 'lastSmartMeterReadFileHash', { privateKey: assetSmartmeterPK });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'saveSmartMeterRead: asset not active');
        }
        chai_1.assert.isTrue(failed);
    }));
    it('should fail when trying to active an asset as non-manager', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setActive(0, true, { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'user does not have the required role');
    ...
    it('should be able to deactive an asset', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.setActive(0, true, { privateKey: privateKeyDeployment });
        const eventActive = (yield assetProducingLogic.getAllLogAssetSetInactiveEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }));
        chai_1.assert.equal(eventActive.length, 0);
        const eventInactive = (yield assetProducingLogic.getAllLogAssetSetActiveEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }))[0];
        chai_1.assert.equal(eventInactive.event, 'LogAssetSetActive');
        chai_1.assert.deepEqual(eventInactive.returnValues, {
            0: '0', _assetId: '0',
        });
    }));
    it('should fail when trying to call update', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.update('0x7110d0f07be70fc2a6c84fe66bf128593b2102fb', { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
    ...
    it('should return 0x0 when an asset does not have a marketLogicContractLookup-address set', () => __awaiter(this, void 0, void 0, function* () {
        chai_1.assert.equal(yield assetProducingLogic.getMarketLookupContract(0), '0x0000000000000000000000000000000000000000');
    }));
    it('should fail trying to set marketAddress as admin', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setMarketLookupContract(0, '0x1000000000000000000000000000000000000005', { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
    ...
    it('should fail trying to set marketAddress as random user', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setMarketLookupContract(0, '0x1000000000000000000000000000000000000005', { privateKey: matcherPK });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'sender is not the assetOwner');
    ...
    it('should fail trying to set marketAddress as admin', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setMarketLookupContract(0, '0x1000000000000000000000000000000000000005', { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'sender is not the assetOwner');
    ...
    it('should set marketAddress', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.setMarketLookupContract(0, '0x1000000000000000000000000000000000000005', { privateKey: assetOwnerPK });
        chai_1.assert.equal(yield assetProducingLogic.getMarketLookupContract(0), '0x1000000000000000000000000000000000000005');
    }));
    it('should not add a matcher as admin', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.addMatcher(0, '0x1000000000000000000000000000000000000000', { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
    ...
    it('should not add a matcher as random user', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.addMatcher(0, '0x1000000000000000000000000000000000000000', { privateKey: matcherPK });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'addMatcher: not the owner');
    ...
    it('should add a matcher', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.addMatcher(0, '0x1000000000000000000000000000000000000000', { privateKey: assetOwnerPK });
        const matcherArray = (yield assetProducingLogic.getMatcher(0));
        chai_1.assert.deepEqual(matcherArray, [matcher, '0x1000000000000000000000000000000000000000']);
    }));
    it.skip('should not add the same a matcher', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.addMatcher(0, '0x1000000000000000000000000000000000000000', { privateKey: assetOwnerPK });
        const matcherArray = (yield assetProducingLogic.getMatcher(0));
        chai_1.assert.deepEqual(matcherArray, [matcher, '0x1000000000000000000000000000000000000000']);
    }));
    it('should not remove a matcher as admin', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.removeMatcher(0, matcher, { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
    ...
    it('should not remove a matcher as random user', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.removeMatcher(0, matcher, { privateKey: matcherPK });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'removeMatcher: not the owner');
    ...
    it('should remove a matcher', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.removeMatcher(0, matcher, { privateKey: assetOwnerPK });
        const matcherArray = (yield assetProducingLogic.getMatcher(0));
    ...
    it('should remove remaining matcher', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.removeMatcher(0, '0x1000000000000000000000000000000000000000', { privateKey: assetOwnerPK });
    }));
    it('should add more matcher', () => __awaiter(this, void 0, void 0, function* () {
        for (let i = 0; i < 10; i++) {
            yield assetProducingLogic.addMatcher(0, '0x100000000000000000000000000000000000000' + i, { privateKey: assetOwnerPK });
        }
        const matcherArray = (yield assetProducingLogic.getMatcher(0));
        chai_1.assert.deepEqual(matcherArray, ['0x1000000000000000000000000000000000000000',
    ...
    it('should return updated assetGeneral correctly', () => __awaiter(this, void 0, void 0, function* () {
        const ag = yield assetProducingLogic.getAssetGeneral(0);
        chai_1.assert.deepEqual(ag, {
            0: assetSmartmeter,
            1: assetOwnerAddress,
            2: '200',
            3: true,
            ...
            matcher: ['0x1000000000000000000000000000000000000000',
                '0x1000000000000000000000000000000000000001',
                '0x1000000000000000000000000000000000000002',
                '0x1000000000000000000000000000000000000003',
                '0x1000000000000000000000000000000000000004',
    ...
    it('should not add a 10th matcher', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.addMatcher(0, '0x1000000000000000000000000000000000000010', { privateKey: assetOwnerPK });
        }
        catch (ex) {
            failed = true;
    ...
    it('should remove all 10 matcher', () => __awaiter(this, void 0, void 0, function* () {
        for (let i = 9; i >= 0; i--) {
            yield assetProducingLogic.removeMatcher(0, '0x100000000000000000000000000000000000000' + i, { privateKey: assetOwnerPK });
        }
        const matcherArray = (yield assetProducingLogic.getMatcher(0));
    ...
    it('should not onboard assets with too many matcher', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.createAsset(assetSmartmeter, assetOwnerAddress, true, [
            ...
            ], 'propertiesDocumentHash', 'url', 2, { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'addMatcher: too many matcher already');
    ...
    it('should return empty asset (sm#2) correctly', () => __awaiter(this, void 0, void 0, function* () {
        const deployedAsset = yield assetProducingLogic.getAssetBySmartMeter(assetSmartMeter2);
        // producing has 2 properties: maxOwnerChanges + assetGeneralStruct
        chai_1.assert.equal(deployedAsset.length, 2);
        chai_1.assert.equal(deployedAsset.maxOwnerChanges, 0);
        // checking the number of properties in assetGeneral
        chai_1.assert.equal(deployedAsset.assetGeneral.length, 10);
        const ag = deployedAsset.assetGeneral;
        chai_1.assert.equal(ag.smartMeter, '0x0000000000000000000000000000000000000000');
    ...
    it('should onboard assets with 10 matcher', () => __awaiter(this, void 0, void 0, function* () {
        const tx = yield assetProducingLogic.createAsset(assetSmartMeter2, assetOwnerAddress, true, [
            '0x1000000000000000000000000000000000000000',
            '0x1000000000000000000000000000000000000001',
            '0x1000000000000000000000000000000000000002',
            '0x1000000000000000000000000000000000000003',
            ...
            '0x1000000000000000000000000000000000000008',
            '0x1000000000000000000000000000000000000009',
        ], 'propertiesDocumentHash#2', 'url#2', 2, { privateKey: privateKeyDeployment });
        const event = (yield assetProducingLogic.getAllLogAssetCreatedEvents({ fromBlock: tx.blockNumber, toBlock: tx.blockNumber }))[0];
        chai_1.assert.equal(event.event, 'LogAssetCreated');
        chai_1.assert.deepEqual(event.returnValues, {
            0: accountDeployment,
        ...
        const deployedAsset = yield assetProducingLogic.getAssetById(1);
        // producing has 2 properties: maxOwnerChanges + assetGeneralStruct
        chai_1.assert.equal(deployedAsset.length, 2);
        chai_1.assert.equal(deployedAsset.maxOwnerChanges, 2);
        // checking the number of properties in assetGeneral
        ...
        chai_1.assert.equal(ag.url, 'url#2');
        chai_1.assert.equal(ag.marketLookupContract, '0x0000000000000000000000000000000000000000');
        chai_1.assert.deepEqual(yield assetProducingLogic.getMatcher(1), ['0x1000000000000000000000000000000000000000',
            '0x1000000000000000000000000000000000000001',
            '0x1000000000000000000000000000000000000002',
            '0x1000000000000000000000000000000000000003',
            '0x1000000000000000000000000000000000000004',
    ...
    it('should return asset (sm#2) correctly', () => __awaiter(this, void 0, void 0, function* () {
        const deployedAsset = yield assetProducingLogic.getAssetBySmartMeter(assetSmartMeter2);
        // producing has 2 properties: maxOwnerChanges + assetGeneralStruct
        chai_1.assert.equal(deployedAsset.length, 2);
        chai_1.assert.equal(deployedAsset.maxOwnerChanges, 2);
    ...
    it('should return assetGeneral#2 correctly', () => __awaiter(this, void 0, void 0, function* () {
        const ag = yield assetProducingLogic.getAssetGeneral(1);
        chai_1.assert.deepEqual(ag, {
            0: assetSmartMeter2,
            1: assetOwnerAddress,
            2: '0',
    ...
    it('should fail when trying to activate a non existing bundle', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setBundleActive(3, true, { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
        }
    ...
    it('should fail when trying to activate an existing bundle as admin', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setBundleActive(0, true, { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'setBundleActive: not the owner');
        }
        chai_1.assert.isTrue(failed);
    }));
    it('should fail when trying to activate an existing bundle as trader', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetProducingLogic.setBundleActive(0, true, { privateKey: privateKeyDeployment });
        }
    ...
    it('should activate an existing bundle as assetOwner', () => __awaiter(this, void 0, void 0, function* () {
        yield assetProducingLogic.setBundleActive(0, true, { privateKey: assetOwnerPK });
        let ag = yield assetProducingLogic.getAssetGeneral(0);
        chai_1.assert.deepEqual(ag, {
            0: assetSmartmeter,
            1: assetOwnerAddress,
            2: '200',
        ...
        chai_1.assert.isTrue(ag.active);
        chai_1.assert.equal(ag.lastSmartMeterReadFileHash, 'lastSmartMeterReadFileHash#2');
        chai_1.assert.deepEqual(ag.matcher, []);
        chai_1.assert.equal(ag.propertiesDocumentHash, 'propertiesDocumentHash');
        chai_1.assert.equal(ag.url, 'url');
        chai_1.assert.equal(ag.marketLookupContract, '0x1000000000000000000000000000000000000005');
        chai_1.assert.isTrue(ag.bundled);
    }));
    it('should return the correct latest hashes + meterreadings', () => __awaiter(this, void 0, void 0, function* () {
        chai_1.assert.deepEqual(yield assetProducingLogic.getLastMeterReadingAndHash(0), {
            0: '200',
            1: 'lastSmartMeterReadFileHash#2',
            _lastSmartMeterReadWh: '200',
            _lastSmartMeterReadFileHash: 'lastSmartMeterReadFileHash#2',
        });
        chai_1.assert.deepEqual(yield assetProducingLogic.getLastMeterReadingAndHash(1), {
            0: '0',
            1: '',
            _lastSmartMeterReadWh: '0',
            _lastSmartMeterReadFileHash: '',
        });
        it('should fail when trying to return latest hash + meterreading of a non existing asset', () => __awaiter(this, void 0, void 0, function* () {
            let failed = false;
            try {
                yield assetProducingLogic.getLastMeterReadingAndHash(2);
            }
            catch (ex) {
                failed = true;
            }
...
//# sourceMappingURL=AssetProducingLogic.js.map
...
exports.createAsset = (assetPropertiesOnChain, assetPropertiesOffChain, configuration) => __awaiter(this, void 0, void 0, function* () {
    ...
    const tx = yield configuration.blockchainProperties.producingAssetLogicInstance.createAsset(assetPropertiesOnChain.smartMeter.address, assetPropertiesOnChain.owner.address, assetPropertiesOnChain.active, assetPropertiesOnChain.matcher.map((matcher) => matcher.address), assetPropertiesOnChain.propertiesDocumentHash, assetPropertiesOnChain.url, assetPropertiesOnChain.maxOwnerChanges, {
...
class Entity extends Asset.Entity {
    ...
    sync() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.id != null) {
                const asset = yield this.configuration.blockchainProperties.producingAssetLogicInstance.getAssetById(this.id);
    ...
    saveSmartMeterRead(meterReading, filehash) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.configuration.blockchainProperties.activeUser.privateKey) {
                return this.configuration.blockchainProperties.producingAssetLogicInstance.saveSmartMeterRead(this.id, meterReading, filehash, { privateKey: this.configuration.blockchainProperties.activeUser.privateKey });
            }
            else {
                return this.configuration.blockchainProperties.producingAssetLogicInstance.saveSmartMeterRead(this.id, meterReading, filehash, { from: this.configuration.blockchainProperties.activeUser.address });
            }
        });
    }
}

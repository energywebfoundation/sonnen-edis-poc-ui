...
describe('AssetContractLookup', () => {
    ...
    it('should have the right owner', () => __awaiter(this, void 0, void 0, function* () {
        ...
        chai_1.assert.equal(yield assetContractLookup.owner(), accountDeployment);
    }));
    it('should have the right registries', () => __awaiter(this, void 0, void 0, function* () {
        chai_1.assert.equal(yield assetContractLookup.assetConsumingRegistry(), assetConsumingLogic.web3Contract._address);
        chai_1.assert.equal(yield assetContractLookup.assetProducingRegistry(), assetProducingLogic.web3Contract._address);
        chai_1.assert.equal(yield assetContractLookup.userRegistry(), userContractLookup.web3Contract._address);
    }));
    it('should throw an error when calling init again', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetContractLookup.init('0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000005', { privateKey: privateKeyDeployment });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'alreadny initialized');
        }
    ...
    it('should throw an error when calling update as non Owner', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetContractLookup.update('0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000005', { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
    ...
    it('should be able to update as owner', () => __awaiter(this, void 0, void 0, function* () {
        yield assetContractLookup.update('0x1000000000000000000000000000000000000005', '0x1000000000000000000000000000000000000006', { privateKey: privateKeyDeployment });
        chai_1.assert.equal(yield assetContractLookup.assetProducingRegistry(), '0x1000000000000000000000000000000000000005');
        chai_1.assert.equal(yield assetProducingDB.owner(), '0x1000000000000000000000000000000000000005');
        chai_1.assert.equal(yield assetContractLookup.assetConsumingRegistry(), '0x1000000000000000000000000000000000000006');
        chai_1.assert.equal(yield assetConsumingDB.owner(), '0x1000000000000000000000000000000000000006');
    }));
    it('should throw when trying to change owner as non-owner', () => __awaiter(this, void 0, void 0, function* () {
        let failed = false;
        try {
            yield assetContractLookup.changeOwner('0x1000000000000000000000000000000000000005', { privateKey: '0x191c4b074672d9eda0ce576cfac79e44e320ffef5e3aadd55e000de57341d36c' });
        }
        catch (ex) {
            failed = true;
            chai_1.assert.include(ex.message, 'msg.sender is not owner');
    ...
    it('should be able to change owner ', () => __awaiter(this, void 0, void 0, function* () {
        yield assetContractLookup.changeOwner('0x1000000000000000000000000000000000000005', { privateKey: privateKeyDeployment });
        chai_1.assert.equal(yield assetContractLookup.owner(), '0x1000000000000000000000000000000000000005');
    }));
});
//# sourceMappingURL=AssetContractLookup.js.map